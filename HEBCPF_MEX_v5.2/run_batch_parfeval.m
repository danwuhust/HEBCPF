...
%% =========================================================
cases_to_run = {
%     'case3',         % 6 % 0.12 sec at handback = 0.5, slopemax = 4e5
%     'case4gs',       % 4 % 0.14 sec
%     'case4BB0',      % 14 % 0.30 sec 
%     'case4BBc',      % 12 % 0.17 sec
%     'case5loop',     % 10 % 0.33 sec
%     'case5Salam',    % 10 % 0.54 sec
%     'case6ww',       % 6 % 0.23 sec
%     'case7Salam',    % 4 % 0.14 sec
%     'case9',         % 8 % 0.30 sec
%     'case9Q',        % 8 % 0.32 sec
%     'case14mod',     % 30 % 1.70 sec
%     'case33bw',      % 16 % 3.60 sec
%     'case39',        % 176 % 34.80 sec
%     'case30',        % 472 % 58.12 sec
    'case57mod',     % 606 % 173.02 sec at handback = 0.5, slopemax = 4e5
%     'case57',     % 1322 % 376.07 sec
};

%% Trace-scheduling policy: 'scan', 'bandit' (default), or 'novelty'.
% Legacy v5 'diverse' maps to 'bandit'. See POLICY_README.md.
global HEBCPOLICY %#ok<GVMIS>
HEBCPOLICY = trace_policy_config('bandit');  % edit to scan or novelty
