...
Upload the following six files in the **Assets** area of the HEBCPF V5 GitHub
Release:
...
## V5 KLU binary and source

The V5 KLU binary was rebuilt from official SuiteSparse `v7.12.2`, commit
...
`HEBCPF_MEX_v5/klurf.mexw64` all have SHA-256:

`e84e55c40afd1268a6ccf994df6932b184193fefee33a55bd5523a3a1fee2ff2`

## V5 benchmark evidence

`HEBCPF-v5-benchmark-raw.zip` contains the official V5 dataset from the
...
current auxiliary machine is included.
