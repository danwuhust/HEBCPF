function [Z, Time, NY_inc, stalled] = trace_equation_worker(MS, M0, Tinv, Ma, Mp, Mq, Ybus, ...
...
%    NY_inc  - increment in the number of columns of the Y matrix
    ...
    % flag curves that hit the outstep cap (a stall); returned as the 4th output
    stalled = exist('outstep','var') && outstep>=param.outnum;
