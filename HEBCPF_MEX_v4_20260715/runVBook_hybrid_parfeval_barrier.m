...
while numberofsolutions+1>solutionnumber
    ...
    if totalTime/30000>totalTime_ind
        ...
        % Futures, the pool, optional pool.Constants, and their accessor are
        % runtime-only objects. The resume path rebuilds them from MS/M0/etc.
        save('temp_result.mat', '-v7.3', '-regexp', ...
            '^(?!(futures|p|MS_c|M0_c|Tinv_c|Ma_c|Mp_c|Mq_c|Ybus_c|useConst)$).');
